...
JAR = jar      # replace with path to jar or jar.exe
JAVA = /usr/bin/java    # replace with path to java or javaw.exe
MP = --module-path javafx/javafx-sdk-11.0.2/lib --add-modules javafx.controls,javafx.fxml #-Dfile.encoding=UTF-8 
...
zip:
	zip team.zip Makefile *.txt *.css *.bat *.png *.jpg *.jar doc/*  application/*
